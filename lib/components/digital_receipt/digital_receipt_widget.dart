...
class DigitalReceiptWidget extends StatefulWidget {
  ...
  @override
  State<DigitalReceiptWidget> createState() => _DigitalReceiptWidgetState();
}

class _DigitalReceiptWidgetState extends State<DigitalReceiptWidget> {
  late DigitalReceiptModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DigitalReceiptModel());
                    ...
                    children: [
                            ...
                            return Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(
                                      '${rowUsersRecord.riderFirstName} ${rowUsersRecord.riderLastName}',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
                                    ...
                                    Text(
                                      rowUsersRecord.riderPhoneNumber,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
                      ...
                      Row(
                        ...
                        children: [
                          Builder(
                            builder: (context) {
                              final services = _model.servicesWithFees.toList();
