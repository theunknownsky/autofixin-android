...
abstract class FlutterFlowTheme {
  ...
  late Color blackBGFontColor;
  late Color greenBGFontColor;
  late Color blackButton;
  late Color linkFontColor;
  late Color hintFontColor;
  late Color formBorderColor;
  late Color lightGreenBGColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF17A77C);
  ...
  late Color greenButton = Color(0xFF17A77C);
  late Color blackBGFontColor = Color(0xFF45DFB1);
  late Color greenBGFontColor = Color(0xFFFFFFFF);
  late Color blackButton = Color(0xFF000000);
  late Color linkFontColor = Color(0xFF304FFE);
  late Color hintFontColor = Color(0xFFB3B3B3);
  late Color formBorderColor = Color(0xFFD9D9D9);
  late Color lightGreenBGColor = Color(0xFFEDFDF8);
}
