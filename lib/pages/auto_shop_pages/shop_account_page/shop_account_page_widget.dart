...
class ShopAccountPageWidget extends StatefulWidget {
  const ShopAccountPageWidget({super.key});

  static String routeName = 'ShopAccountPage';
  static String routePath = '/shopAccountPage';

  @override
  State<ShopAccountPageWidget> createState() => _ShopAccountPageWidgetState();
}

class _ShopAccountPageWidgetState extends State<ShopAccountPageWidget> {
  late ShopAccountPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShopAccountPageModel());
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Builder(
                                builder: (context) {
                                  final shopServicesList =
                                      _model.shopServicesWithPrices.toList();
                                  ...
                                  return Column(
                                    ...
                                    children:
                                        List.generate(shopServicesList.length,
                                            (shopServicesListIndex) {
                                      final shopServicesListItem =
                                          shopServicesList[
                                              shopServicesListIndex];
                                      return Text(
                                        shopServicesListItem,
                                        style: FlutterFlowTheme.of(context)
                                            .titleMedium
                                            .override(
                                              fontFamily: 'Poppins',
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                            ShopTransactionRecordPageWidget
                                                .routeName);
                                      },
                                      child: Text(
                                        'View',
