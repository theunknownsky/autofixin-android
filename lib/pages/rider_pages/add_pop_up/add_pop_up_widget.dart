...
import 'add_pop_up_model.dart';
export 'add_pop_up_model.dart';

class AddPopUpWidget extends StatefulWidget {
  const AddPopUpWidget({super.key});
...
class _AddPopUpWidgetState extends State<AddPopUpWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddPopUpModel());

    _model.manucafturerFieldTextController ??= TextEditingController();
    ...
    _model.modelFieldTextController ??= TextEditingController();
    _model.modelFieldFocusNode ??= FocusNode();

    _model.colorFieldTextController ??= TextEditingController();
    _model.colorFieldFocusNode ??= FocusNode();

    _model.plateNumberFieldTextController ??= TextEditingController();
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  TextFormField(
                                    controller: _model.modelFieldTextController,
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  TextFormField(
                                    controller: _model.colorFieldTextController,
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  TextFormField(
                                    controller:
                                        _model.plateNumberFieldTextController,
                                    focusNode: _model.plateNumberFieldFocusNode,
                                    autofocus: false,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      isDense: true,
                            ...
                            Expanded(
                              child: Align(
                                ...
                                child: FlutterFlowDropDown<String>(
                                  ...
                                  onChanged: (val) => safeSetState(() =>
                                      _model.transmissionDropDownValue = val),
                                  width: 200.0,
                                  height: 60.0,
                                  textStyle: FlutterFlowTheme.of(context)
                                      .bodyMedium
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          await vehiclesRecordReference
                            ...
                            vehicleModel: _model.modelFieldTextController.text,
                            vehicleColor: _model.colorFieldTextController.text,
                            vehiclePlateNumber:
                          ...
                          _model.vehicleCreated =
                              VehiclesRecord.getDocumentFromData(
                                  createVehiclesRecordData(
                                    vehicleManufacturer: _model
                                        .manucafturerFieldTextController.text,
                                    vehicleYear: int.tryParse(
                                        _model.yearFieldTextController.text),
                                    vehicleModel:
                                    ...
                                    vehiclePlateNumber: _model
                                        .plateNumberFieldTextController.text,
                                    vehicleType: _model.typeDropDownValue,
                                    vehicleTransmission:
                                        _model.transmissionDropDownValue,
                                  ),
                                  vehiclesRecordReference);

                          await currentUserReference!.update({
                            ...mapToFirestore(
                              {
                                'rider_vehicles': FieldValue.arrayUnion(
                                    [_model.vehicleCreated?.reference]),
                              },
                            ),
                          });
                          Navigator.pop(context);
