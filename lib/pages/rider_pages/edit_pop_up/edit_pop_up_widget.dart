...
import 'edit_pop_up_model.dart';
export 'edit_pop_up_model.dart';
...
class _EditPopUpWidgetState extends State<EditPopUpWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditPopUpModel());
                            ...
                            children: [
                              Expanded(
                                child: Align(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.manucafturerFieldTextController,
                                    focusNode:
                              ...
                              Expanded(
                                child: Align(
                                  alignment: AlignmentDirectional(-1.0, 0.0),
                                  child: TextFormField(
                                    controller: _model.yearFieldTextController,
                                  ...
                                  Expanded(
                                    child: Align(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        controller: _model
                                                .vehicleTypeFieldValueController ??=
                                            FormFieldController<String>(
                                          _model.vehicleTypeFieldValue ??=
                                              'Two-wheeler',
                                        ),
                                        options: [
                                          'Two-wheeler',
                                        ...
                                        onChanged: (val) => safeSetState(() =>
                                            _model.vehicleTypeFieldValue = val),
                                        width:
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Align(
                                      ...
                                      child: FlutterFlowDropDown<String>(
                                        controller: _model
                                                .transmissionrFieldValueController ??=
                                            FormFieldController<String>(
                                          _model.transmissionrFieldValue ??=
                                              'Automatic',
                                        ),
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.vehicleTypeFieldValue == null) {
                                  return;
                                }
                                if (_model.transmissionrFieldValue == null) {
                                  return;
                                }
                                Navigator.pop(context);
                              },
