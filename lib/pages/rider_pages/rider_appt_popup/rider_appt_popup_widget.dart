...
class RiderApptPopupWidget extends StatefulWidget {
  const RiderApptPopupWidget({
    super.key,
  ...
  @override
  State<RiderApptPopupWidget> createState() => _RiderApptPopupWidgetState();
}

class _RiderApptPopupWidgetState extends State<RiderApptPopupWidget> {
  late RiderApptPopupModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RiderApptPopupModel());
