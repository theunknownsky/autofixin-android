...
class RiderVehiclesPageWidget extends StatefulWidget {
  const RiderVehiclesPageWidget({super.key});

  static String routeName = 'RiderVehiclesPage';
  static String routePath = '/riderVehiclesPage';

  @override
  State<RiderVehiclesPageWidget> createState() =>
      _RiderVehiclesPageWidgetState();
}

class _RiderVehiclesPageWidgetState extends State<RiderVehiclesPageWidget> {
  late RiderVehiclesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RiderVehiclesPageModel());
          ...
          child: Stack(
            children: [
              Padding(
                ...
                child: Builder(
                  builder: (context) {
                    final vehicle = _model.vehiclesList.toList();
