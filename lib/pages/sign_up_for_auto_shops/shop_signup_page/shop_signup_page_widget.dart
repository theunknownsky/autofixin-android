...
import 'shop_signup_page_model.dart';
export 'shop_signup_page_model.dart';

/// Owner / Rider details
class ShopSignupPageWidget extends StatefulWidget {
  const ShopSignupPageWidget({super.key});

  static String routeName = 'ShopSignupPage';
  static String routePath = '/shopSignupPage';

  @override
  State<ShopSignupPageWidget> createState() => _ShopSignupPageWidgetState();
}

class _ShopSignupPageWidgetState extends State<ShopSignupPageWidget> {
  late ShopSignupPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ShopSignupPageModel());
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: 'juanautoshop@gmail.com',
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                                        fontFamily: 'Poppins',
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          context.pushNamed(
                            ShopSignupPage2Widget.routeName,
                            queryParameters: {
