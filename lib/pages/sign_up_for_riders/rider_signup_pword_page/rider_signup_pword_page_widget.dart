...
class RiderSignupPwordPageWidget extends StatefulWidget {
  const RiderSignupPwordPageWidget({
    super.key,
  ...
  static String routeName = 'RiderSignupPwordPage';
  static String routePath = '/riderSignupPwordPage';

  @override
  State<RiderSignupPwordPageWidget> createState() =>
      _RiderSignupPwordPageWidgetState();
}

class _RiderSignupPwordPageWidgetState
    extends State<RiderSignupPwordPageWidget> {
  late RiderSignupPwordPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RiderSignupPwordPageModel());
